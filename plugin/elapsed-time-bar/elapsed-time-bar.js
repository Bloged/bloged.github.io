var ElapsedTimeBar = {
  ...
  handleReady() {
    ...
    var barDisplay;
    if(config.timeProgressBarStyle != 'speaker' || url.searchParams.get('receiver') != null) {
      barDisplay = 'block';
    } else if(config.timeProgressBarStyle == 'speaker') {
      barDisplay = 'hidden';
    } else {
      alert(config.timeProgressBarStyle != 'speaker');
    }
